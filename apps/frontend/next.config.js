...
const nextConfig = {
  ...
  // Enable production sourcemaps for Sentry (only needed in prod)
...
// Skip Sentry wrapping in dev — it adds Sentry webpack plugins that slow down
// every page compilation significantly.  Sentry features (sourcemap upload,
// release tagging) are only useful in production builds.
